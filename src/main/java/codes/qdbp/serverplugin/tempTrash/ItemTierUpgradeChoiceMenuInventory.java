...
//    String itemName;
//
//    public ItemTierUpgradeChoiceMenuInventory(String itemName) {
//
//        this.itemTierUpgradeChoiceMenuInventory = Bukkit.createInventory(null, 9, Component.text("Upgrade tier costs"));
//
...
//                    Component.text(itemName + " x 1 with Efficiency Upgrade " + (tier - 1)),
